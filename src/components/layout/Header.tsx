    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-4 lg:gap-6">
          <Link to="/" className="text-slate-700 hover:text-indigo-700 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 rounded-md px-2 py-1">
            Home
          </Link>
          ...
          {user && (
            <div className="relative">
              ...
              >
                ...
                <ChevronDown 
                  size={16} 
                  className={`transition-transform duration-200 ${activeDropdown === 'dashboard' ? 'rotate-180' : ''}`} 
                  aria-hidden="true" 
                />
              </button>
              ...
              <AnimatePresence>
                {activeDropdown === 'dashboard' && (
                  <motion.div
                    ...
                    className="absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10 py-1"
                    role="menu"
                  ...
                  >
                    {dropdownMenus.dashboard.map((item) => (
                      <Link
                        key={item.path}
                        to={item.path}
                        className="flex items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 hover:text-indigo-700"
                        role="menuitem"
                      >
                      ...
                      {dropdownMenus.profile.map((item, index) => (
                        item.onClick ? (
                          <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 hover:text-indigo-700 w-full text-left"
                            role="menuitem"
                          >
                            <item.icon size={16} aria-hidden="true" />
                            <span>{item.label}</span>
        ...
        {isMenuOpen && (
          ...
          >
            <div className="container mx-auto px-4 py-4 flex flex-col gap-4">
              <Link to="/" className="py-2 text-slate-700 hover:text-indigo-700 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 rounded-md">
                Home
              </Link>
