...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE event_types ADD COLUMN religion TEXT;
  END IF;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE event_types ADD COLUMN sort_order INTEGER DEFAULT 0;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM event_types WHERE religion IS NOT NULL LIMIT 1) THEN
    INSERT INTO event_types (name_en, description_en, icon, religion, sort_order)
    VALUES
      -- Judaism
      ('Passing Announcement', 'Announcement of death', NULL, 'Judaism', 100),
      ('Funeral and Burial Service', 'Jewish funeral service', NULL, 'Judaism', 101),
      ('Shiva', 'Seven-day mourning period', NULL, 'Judaism', 102),
      ('Shloshim', 'Thirty-day mourning period', NULL, 'Judaism', 103),
      ('Gravestone Unveiling', 'Unveiling ceremony', NULL, 'Judaism', 104),
      ('End of Mourning Year Ceremony', 'End of mourning year', NULL, 'Judaism', 105),
      ('Annual Yahrzeit', 'Annual remembrance', NULL, 'Judaism', 106),
      
      -- Christianity
      ('Wake / Vigil', 'Pre-funeral gathering', NULL, 'Christianity', 200),
      ('Funeral Service', 'Christian funeral service', NULL, 'Christianity', 201),
      ('Committal Service', 'Burial service', NULL, 'Christianity', 202),
      ('Repast / Reception', 'Post-funeral gathering', NULL, 'Christianity', 203),
      ('Third Day Memorial', 'Memorial on the third day', NULL, 'Christianity', 204),
      ('Ninth Day Memorial', 'Memorial on the ninth day', NULL, 'Christianity', 205),
      ('Fortieth Day Memorial', 'Memorial on the fortieth day', NULL, 'Christianity', 206),
      ('Six Month Memorial', 'Memorial at six months', NULL, 'Christianity', 207),
      ('One Year Memorial', 'Memorial at one year', NULL, 'Christianity', 208),
      ('All Souls Day', 'Commemoration of the faithful departed', NULL, 'Christianity', 209),
      ('Soul Saturdays', 'Eastern Orthodox memorial days', NULL, 'Christianity', 210),
      ('Radonitsa', 'Eastern Orthodox memorial day', NULL, 'Christianity', 211),
      
      -- Islam
      ('Ghusl al-Mayyit', 'Ritual washing of the deceased', NULL, 'Islam', 300),
      ('Salat al-Janazah', 'Funeral prayer', NULL, 'Islam', 301),
      ('Tashyi al-Janazah', 'Funeral procession', NULL, 'Islam', 302),
      ('Al-Dafn', 'Burial', NULL, 'Islam', 303),
      ('Al-Aza / Al-Taziyah', 'Condolence gathering', NULL, 'Islam', 304),
      ('Majalis al-Khatm', 'Quran recitation gatherings', NULL, 'Islam', 305),
      ('Majalis al-Dhikr', 'Remembrance gatherings', NULL, 'Islam', 306),
      ('Ziyarat al-Qubur', 'Visiting graves', NULL, 'Islam', 307),
      
      -- General, National, Commemorative & Interfaith Events
      ('Interfaith Ceremony', 'Multi-faith memorial service', NULL, 'Interfaith', 400),
      ('Annual Remembrance Event', 'Yearly memorial gathering', NULL, 'General', 401),
      ('Digital Memorial Launch', 'Launch of online memorial', NULL, 'General', 402),
      ('Community Gathering', 'Community memorial event', NULL, 'General', 403),
      ('Charity Event in Memory', 'Charitable event honoring the deceased', NULL, 'General', 404),
      ('Remembrance Day', 'General day of remembrance', NULL, 'General', 405),
      ('Fallen Soldiers Remembrance', 'Military memorial day', NULL, 'National', 406),
      ('Holocaust Remembrance Day', 'Holocaust memorial day', NULL, 'National', 407),
      ('National Day of Remembrance', 'Country-specific remembrance day', NULL, 'National', 409),
      ('Memorial Day', 'National memorial day', NULL, 'National', 410),
      ('Organizational Memorial', 'Organization-specific memorial', NULL, 'General', 411);
  END IF;
END $$;
